...
public final class AssignAuthentication_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String id=(String)session.getAttribute("acc_prof_userid");
      ...
      out.write("    <body>\n");
      out.write("        <pre>\n");
      out.write("        <h1>Fill Authentication details for -");
      out.print(name);
      out.write("</h1>\n");
      out.write("        <h2>           ");
      out.print(id);
      out.write("</h2>\n");
      out.write("        <form action=\"RespondProfessor\" method=\"post\">\n");
      out.write("        <table>\n");
      out.write("            <tbody>\n");
      out.write("                <tr>\n");
